...
export default function ExerciseObj({obj})
{
    ...
    return <div className="border-2 rounded-md px-2 py-1">
        ...
        <div className="mt-7 flex items-center"> 
           ...
           <div className="flex-[1] flex justify-end "><GoCheck className="inline bg-gray-100 border-2 border-gray-100  rounded-[50%] hover:brightness-50 " color="green" /></div>
        </div>
